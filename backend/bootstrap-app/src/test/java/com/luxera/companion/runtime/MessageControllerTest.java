...
class MessageControllerTest {
    ...
    void agentRuntimeProcessesPersistedMessages() {
        ...
        v7AgentRuntime.process("v7-user", companionId, conversationId,
                com.luxera.companion.conversation.MessageViews.toViews(java.util.List.of(persisted)));
    ...
    void agentRuntimeProcessDoesNotThrow() {
        ...
        assertDoesNotThrow(() -> v7AgentRuntime.process(
                "v7-user", companionId, conversationId,
                com.luxera.companion.conversation.MessageViews.toViews(java.util.List.of(persisted))));
    }
