...
class BehaviorEngineTest {
    ...
    // 相对"今天"取固定下午 15:00: 日期跟着真实时钟走(避免 2026-08-19 那次的日期漂移),
    // 但小时必须固定 —— 否则凌晨跑测试时她正在睡觉, CompanionSchedule.proactiveFactor 返回 0,
    // 主动联系候选恒得零分, 断言会随"什么时候跑测试"而失败。
    private static final LocalDateTime TEST_NOON =
