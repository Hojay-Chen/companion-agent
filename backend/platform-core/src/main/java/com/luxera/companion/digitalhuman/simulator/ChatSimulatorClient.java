 ...
 *
 * 与 {@link SimulatorClient} 接口兼容, 但底层通过 {@link ChatSimulatorConnector}
 * 走 WebSocket DHCP v1 协议, 而非直接调 ConversationService(JPA 层)。
 *
...
public class ChatSimulatorClient {
    ...
    public ChatSimulatorClient(ChatSimulatorConnector connector, SimulatorSessionRegistry sessionRegistry) {
