package com.luxera.companion.digitalhuman.application.web;

import com.luxera.companion.digitalhuman.application.ApplicationRegistry;
...
public class ApplicationGameController {
